...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _checkUserVipStatus() async {
    ...
    bool? isBuy =  sharedPreferences.getBool('isBuy');
    ...
    if(isBuy != null){
      ...
      sharedPreferences.setBool('isBuy',false);
    }
  ...
  void _handlePurchaseUpdates() async {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: Row(
            children: [
              Image.asset("assets/images/icon_app_logo.png", width: 40, height: 40),
              SizedBox(width: 5),
              Text(APP_NAME),
            ],
          ),
